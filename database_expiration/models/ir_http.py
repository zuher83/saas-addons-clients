...
class IrHttp(models.AbstractModel):
    ...
    def session_info(self):
        ...
        # _logger.warning("database_expiration_date: %s" % database_expiration_date)
        ...
        if database_expiration_date:
            ...
            if now > database_expiration_date:
                ...
                res["database_block_is_blocked"] = True
            elif delta.days > database_expiration_warning_delay:
                pass
            elif delta.days > 1:
                res[
                    "database_block_message"
                ] = _("Your database will expire in {} days").format(delta.days,)
                ...
                res["database_expiration_message"] = _("Your database will expire today")
                res["database_block_is_warning"] = True
